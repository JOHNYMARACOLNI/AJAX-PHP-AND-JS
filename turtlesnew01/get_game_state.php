...
$stmt = $conn->prepare("SELECT r.game_active, r.current_player_id, r.turn_ends_at, u.name as current_player_name
        FROM rooms r
...
$current_time = time();
$turn_ends = strtotime($data['turn_ends_at']);

if ($data['game_active'] && $turn_ends < $current_time) {
